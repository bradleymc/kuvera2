...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 108;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(10800000000000000);
...
const size_t CRYPTONOTE_COIN_VERSION                          = 2.1.2;
...
const int      P2P_DEFAULT_PORT                              =  19666;
const int      RPC_DEFAULT_PORT                              =  20666;
